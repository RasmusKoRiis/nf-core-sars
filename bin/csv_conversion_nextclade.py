...
nextclade_stats = df[['seqName', 'clade', 'Nextclade_pango', 'partiallyAliased', 'clade_nextstrain', 'clade_who']]
nextclade_stats.columns = ['Sample', 'clade', 'Nextclade_pango', 'partiallyAliased', 'clade_nextstrain', 'clade_who']
