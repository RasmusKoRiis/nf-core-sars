...
include { getGenomeAttribute      } from './subworkflows/local/utils_nfcore_sarscovseq_pipeline'
...
workflow NFCORE_SARSCOVSEQ {
    ...
    emit:
    multiqc_report = SARSCOVSEQ.out.multiqc_report // channel: /path/to/multiqc_report.html
...
workflow {
    ...
    PIPELINE_COMPLETION (
        ...
        params.monochrome_logs,
        params.hook_url,
        NFCORE_SARSCOVSEQ.out.multiqc_report
    )
}
